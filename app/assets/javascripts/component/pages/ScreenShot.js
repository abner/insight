...
window.Feedback.Screenshot = function( options ) {
    ...
    this.h2cDone = false;
    this.skipMarks = this.options.skipMarks || false;
};
...
window.Feedback.Screenshot.prototype.start = function( modal, modalHeader, modalFooter, nextButton, options ) {

    if ( this.h2cDone ) {

        if(this.options.skipMarks){
          nextButton.click();
          return;
        }
        ...
        blackoutButton = element("a", options.blackoutButtonLabel || "Blackout"),
        highlightButton = element("a", options.highlightButtonLabel || "Highlight"),
        previousElement;
        ...
        var highlightBlackoutHelp = options.highlightBlackoutHelp || "Highlight or blackout important information";
        this.dom.appendChild( element("p", highlightBlackoutHelp) );
...
window.Feedback.Screenshot.prototype.data = function() {
    ...
    if ( this.h2cCanvas !== undefined ) {
        ...
        try {
            ...
            return ( this._data = {screenshot: this.h2cCanvas.toDataURL() });
        } catch( e ) {}
