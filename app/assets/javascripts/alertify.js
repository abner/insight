        ...
        */
        ...
        function handleTransitionOutEvent(event, instance) {
            ...
            if (alertify.defaults.maintainFocus && instance.__internal.activeElement) {
              //if colocado para contornar problema relatado em
              // https://github.com/fabien-d/alertify.js/issues/83
              // no qual o scroll é ativado para ir para baixo
              // após fechar de dialogo - no caso foi desativado
              // o focus caso o elemento que ativou foi o body
                if(instance.__internal.activeElement.tagName != 'BODY'){
